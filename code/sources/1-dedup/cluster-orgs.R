...
print("Deduplicating organizations using fastcluster... (this takes about two minutes usually)")
...
sprintf("Found %s unique organizations", nrow(df.clust.final))
