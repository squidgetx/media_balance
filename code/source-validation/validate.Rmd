...
df2.q %>% write_tsv(here('data/climate-excerpts/annotation_results.tsv'))
```
...
err.df %>% write_tsv(here('figures/validation_errors_figure.tsv'))
err.df %>%
...
ggsave(here("figures/validation-result.png"), width = 4.5, height = 4.5)
```
